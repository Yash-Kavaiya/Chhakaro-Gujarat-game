...
ROOT = Path(r"C:\Users\yashk\Downloads\Chhakaro-Gujarat-game")
SRC = ROOT / "src"

# --- 1. WaterOccupancy ---
(SRC / "world" / "WaterOccupancy.ts").write_text(r'''import { RoadGeometryHelper } from './RoadGeometryHelper';
